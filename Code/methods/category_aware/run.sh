...
#onehot
python main.py -mode=train -modelName=cat_all_simple_onehot  -problem=CHESS7SIMPLE -MAX_TGT_SEQ_LEN=70 -category_representation_type=onehot | tee ./logs/cat_all_simple_onehot.log
python main.py -mode=train -modelName=cat_all_attack_onehot  -problem=CHESS7ATTACK -MAX_TGT_SEQ_LEN=70 -category_representation_type=onehot | tee ./logs/cat_all_attack_onehot.log
python main.py -mode=train -modelName=cat_all_score_onehot  -problem=CHESS7SCORE -MAX_TGT_SEQ_LEN=70 -category_representation_type=onehot | tee ./logs/cat_all_score_onehot.log
