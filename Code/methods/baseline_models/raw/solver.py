...
class Solver:
    ...
    def __init__(self,cnfg):
        ...
        elif cnfg.problem=="CHESS0E2ESIMPLE":
            from .utils import readData as readData
            cnfg.srcLang="che"
            cnfg.tgtLang="en"
            cnfg.taskInfo="che-eng.0"
        elif cnfg.problem=="CHESS0E2EATTACK":
            from .utils import readData as readData
            cnfg.srcLang="che"
            cnfg.tgtLang="en"
            cnfg.taskInfo="che-eng.0attackE2E"
        elif cnfg.problem=="CHESS1E2EATTACK":
            from .utils import readData as readData
            cnfg.srcLang="che"
            cnfg.tgtLang="en"
            cnfg.taskInfo="che-eng.1attackE2E"
        elif cnfg.problem=="CHESS2COMPARITIVEE2EATTACK":
            from .utils import readData as readData
            cnfg.srcLang="che"
            cnfg.tgtLang="en"
            cnfg.taskInfo="che-eng.2.comparitiveattackE2E" 
    ...
    def main(self):
        ...
        if cnfg.mode=="train" or cnfg.mode=="LM":
            ...
            model.decodeAll(test_src_batches,modelName,method=cnfg.method,evalMethod="BLEU",suffix="test",lmObj=self.cnfg.lmObj)
            #Also on valid
